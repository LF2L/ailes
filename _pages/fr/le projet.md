...
*NOTES: La page d’accueil pourrait proposer un volet d’information dynamique. Parmi les informations affichées, une présentation très générale du projet (texte ci-dessous) (insistance sur la dimension innovante du projet ; rythme ternaire ; verbes d’action à l’infinitif pour placer le projet résolument dans l’action) :*
